...
import { updateTicketCategoryAction } from "@/lib/actions/ticket-categories/update-ticket-category";
...
interface TicketCategoryUpdateFormProps {
  data: {
    id: number;
    name: string;
...
export default function TicketCategoryUpdateForm({ data }: TicketCategoryUpdateFormProps) {
